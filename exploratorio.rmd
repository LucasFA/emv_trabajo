...
Una única variable presenta datos faltantes, en aproximadamente el 1% de casos. Omitiremos todos estos casos.
...
data_normalizado <- data.frame(scale(var_numericas))
boxplot(
  data_normalizado,
  col = c(seq_len(ncol(data_normalizado))),
  main = "Outliers",
...
str(data_normalizado)
colnames(data_normalizado)
